...
# Argument parser
prsr = ap.ArgumentParser(description= "Implementation of Felix test 3. This script holds a square in the middle of the screen with a fixed background luminance. The square depicts a square wave, which is rotated 90 degrees at a given frequency. Escape can be pressed while the program is running in order to cancel execution and save the results accumulated so far.")

prsr.add_argument('flnm',default='rotatesin.csv',nargs='?',help="The filename of the file where the results will be stored in the results directory. Default: rotatesin.csv")
...
prsr.add_argument('-sc',dest='scyc',default=1,type=int,help='The number of spatial cycles of the square wave. Default: 1')

prsr.add_argument('-tf',dest='tfrq',default=10.0,type=float,help='The temporal frequency in Hz of the rotation operation. Default: 10.0')

prsr.add_argument('-cs',dest='ctst',default=1.0,type=float,help='The contrast of the square wave. Between 0 and 1. Default: 1.0')

prsr.add_argument('-lm',dest='lm',default=0.5,type=float,help='The background luminance. Default: 0.5')
