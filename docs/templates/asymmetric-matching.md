...
[structure of an experiment](../useful-examples/experiment-structure) page. The outer machinery is
...
- [structure of an experiment](../useful-examples/experiment-structure) explains how the modules fit together.
