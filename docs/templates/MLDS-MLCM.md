...
Both use the module layout described in
[structure of an experiment](../useful-examples/experiment-structure) and the data management described in
...
- [2-AFC/2-IFC](2-AFC-2-IFC) is the other forced-choice template, with timed
  intervals.
- [structure of an experiment](../useful-examples/experiment-structure) explains the module layout both templates
  share.
